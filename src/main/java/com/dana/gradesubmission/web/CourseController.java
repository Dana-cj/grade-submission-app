...
import com.dana.gradesubmission.service.CourseService;
...
public class CourseController {
    ...
    public ResponseEntity<List<Student>> getStudents(@PathVariable Long courseId){
        return new ResponseEntity<>(courseService.getStudents(courseId), HttpStatus.OK);
    }
